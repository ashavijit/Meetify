  ...
  return (
    <>
      ...
      <div className="joinpage bg-lightGray flex-grow md:h-screen md:border-l-2 border-lightGray p-3 md:p-4">
        <div className={`joinpage flex p-3 md:p-6 rounded md:rounded-2xl md:h-72 md:w-auto w-full group bg-blue`} >
          <div className="flex md:h-full items-center md:flex-col md:items-start md:justify-between gap-2">
            ...
            <div className="flex-shrink-0 md:mb-5">
              <p className="text-white md:mb-1 text-sm md:text-3xl md:font-bold">
                Scan QR-Code
              </p>
          ...
          <div className="text-white flex md:h-full items-center md:flex-col md:items-start md:justify-between gap-2">
            {scanResultWebCam == "" ?
              <h3 className='my-6'>
                ...
                <div className='md:text-lg'>
                  Align the QR to the camera
                </div>
              </h3>
              :
              <h3 className='my-6'>
                <div className='md:text-2xl md:font-bold'>
                  Meeting Invite Link is:
                </div>
                <div className='md:text-lg'>
                  {scanResultWebCam}
                </div>
            ...
            <br />
            {roomId == "" ?
              <button className="md:text-xl px-4 bg-red py-1 rounded-lg border border-danger my-7" disabled>
                Scan the QR
              </button>
              :
              <button className="md:text-xl px-4 bg-emerald-400 py-1 rounded-lg border border-danger my-7" onClick={joinroomusingid}>
                Join Meeting
              </button>
            }
          </div>
